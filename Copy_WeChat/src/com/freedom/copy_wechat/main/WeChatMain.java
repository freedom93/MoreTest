...
import com.freedom.copy_wechat.R.drawable;
import com.freedom.copy_wechat.R.id;
import com.freedom.copy_wechat.R.layout;

public class WeChatMain extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mTab1 = (ImageView) findViewById(R.id.img_wechat);
		...
		View view1 = mLi.inflate(R.layout.main_tab_chatting, null);
		View view2 = mLi.inflate(R.layout.main_tab_contacts, null);
		View view3 = mLi.inflate(R.layout.main_tab_find, null);
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		if (keyCode == KeyEvent.KEYCODE_BACK && event.getRepeatCount() == 0) { // 获取
			...
			if (menu_display) { // 如果 Menu已经打开 ，先关闭Menu
				...
				intent.setClass(WeChatMain.this, Exit.class);
			...
			if (!menu_display) {
				...
				menuWindow.showAtLocation(this.findViewById(R.id.wechat_main),
	...
	public void btnmainright(View v) {
		Intent intent = new Intent(WeChatMain.this, MainTopRightDialog.class);
		startActivity(intent);
		// Toast.makeText(getApplicationContext(), "点击了功能按钮",
		// Toast.LENGTH_LONG).show();
	}

	public void startchat(View v) { // 疯女 对话界面
		Intent intent = new Intent(WeChatMain.this, ChatActivity.class);
		startActivity(intent);
	...
	public void exit_settings(View v) { // 退出 伪“对话框”，其实是一个activity
		Intent intent = new Intent(WeChatMain.this, ExitFromSettings.class);
		startActivity(intent);
	}

	public void btn_shake(View v) { // 手机摇一摇
		Intent intent = new Intent(WeChatMain.this, ShakeActivity.class);
		startActivity(intent);
	}
}
