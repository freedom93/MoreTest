...
public class Welcomes extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.welcomes_viewpager);
		...
		View view6 = mLi.inflate(R.layout.welcome6, null);
	...
	public void startbutton(View v) {
		startActivity(new Intent().setClass(Welcomes.this,
				WelcomesDoorOpen.class));
		this.finish();
	}
